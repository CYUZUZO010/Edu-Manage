...
import { toast } from "../components/ui/user-toast"
import { BookOpen, Users, FileText, Upload, Calendar, CheckCircle, AlertCircle } from "lucide-react"
    ...
    <div className="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div>
            <h2 className="text-xl font-semibold text-slate-800 mb-4">Upload Course Materials</h2>
